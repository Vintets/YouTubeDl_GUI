...
GUI-враппер для консольной утилиты youtube-dl обновлён для yt-dlp v.2026.1.29
...
> pip install yt-dlp==2026.1.29  [![yt-dlp](https://img.shields.io/badge/>__dlp-yt--dlp-red)](https://github.com/yt-dlp/yt-dlp)
